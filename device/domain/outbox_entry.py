"""OutboxEntry entity — represents a pending outbound message to the core system.
...
class OutboxEntry:
    """Domain entity for an outbox record ensuring reliable delivery to the core system.
