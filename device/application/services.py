...
outbound delivery to the core system via the outbox pattern and Kafka.
"""
...
class DeviceTelemetryAppService:
    ...
    and the outbox (guaranteed forward to the core system via Kafka).
    """
...
class DeviceCommandApplicationService:
    ...
    def acknowledge_embedded_command(self, command: AcknowledgeEmbeddedDeviceCommandCommand) -> DeviceCommand:
        """Persist embedded ACK locally and publish it to Kafka for the core system."""
